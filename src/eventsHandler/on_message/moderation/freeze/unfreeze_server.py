...
async def unfreeze_server(client: discord.Client, message: discord.Message, args: List[str]):
    ...
    try:
        ...
        await message.channel.send(f"Vous avez __refusé__ le dégel du serveur.")
    else:
        ...
        await message.channel.send(f"Le serveur a été dégelé")
